...
<#
.SYNOPSIS
    WinGet Update Remediation Script for Microsoft Intune (System Compatible Version)
...
.DESCRIPTION
    ...
    the app list created by the corresponding detection script. This version uses explicit
...
.NOTES
    File Name      : Remediate-WinGetUpdates-SystemCompatible.ps1
...
.EXAMPLE
    ...
    powershell.exe -ExecutionPolicy Bypass -File "Remediate-WinGetUpdates-SystemCompatible.ps1"
